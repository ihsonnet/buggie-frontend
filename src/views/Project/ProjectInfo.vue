            ...
            <v-col lg="" md="9" sm="12" cols="12">
                ...
                <!-- Assign Member  -->
                   <v-row v-show="memberSelected">
                    ...
                    <!-- Add new bug  -->
                   <v-row v-show="bugSelected && getRoleInProject(userInfo.id)=='TESTER'">
                        <v-col>
                            <v-card style="border: 1px solid #e7e7e7;text-align:center !important" color="#F2F5F8" outlined class="mt-2 pa-4" elevation="0" width="100%">
...
export default {
  ...
  methods: {
    ...
    optionSelector(id){
        ...
        if(id === 1){
            ...
            this.bugSelected=true;
            console.log(1);
            console.log(this.bugSelected);
            console.log(this.memberSelected);
        }
        else if(id === 2){
            this.bugSelected=false;
  ...
  watch: {
      'this.$route.params.projectId': function(projectId){
          this.selectedProject = this.$route.params.projectId;
      },
  }
};
