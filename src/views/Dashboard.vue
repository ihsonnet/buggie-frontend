        ...
        <v-row>
            <v-col lg="3" md="3" sm="12" cols="12">
                <v-card  class="ma-5" elevation="0">
                    <h4>My Projects:</h4>
                    <br>
                    <v-row v-for="item in sideItems" :key="item">
                        <v-col>
                           <v-card elevation="0" class="my-2" :color="getRandomColor()">
                               <v-row>
                                   <v-col cols="3">
                                   ...
                                   <v-col cols="9">
                                       <h3>Dokanee</h3>
                                       <small style="font-size:12;color:gray">By Injamamul Haque Sonet</small> 
                                       <br>
                                       <small>dflhfv ffhbvfv  fbvfbuvy hbfgy dnv fhfg dfvbfdkvhfd bvfhbfjg</small>
                                   </v-col>
                               </v-row>
                           </v-card>
                        </v-col>
                        ...
                        <v-col>
                            <v-card color="purple lighten-5" outlined class="mt-2" elevation="0" style="border: 1px solid #e7e7e7" width="100%">
                                <v-row>
                                   ...
                                   <v-col cols="4">
                                       <h3 class="ma-4"><b>Injamamul Haque Sonet</b></h3>
                                        <v-chip class="mx-4">Project Manager</v-chip>
                                   </v-col>
                                   <v-col>
                                       <v-row>
                                            <v-col>
                                       ...
                                       <v-row>
                                            ...
                                            <v-col>
                                                <v-card-subtitle>
                                                    <b>Address:</b> <br> Dhaka Bangladesh
                                                </v-card-subtitle>
                                            </v-col>
                                       </v-row>
                                   </v-col>
